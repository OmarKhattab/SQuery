...
export default class TeacherDropDown extends Component {
  ...
  render() {
    const options = this.props.school === 'Diablo Valley College' ?  [
        ...
        { key: 10, text:'Brandt, Teresa (Tess)', value: 'Brandt, Teresa (Tess)' },
      ] : null
    ...
    <div>
      <Grid columns={2}>
        <Grid.Column>
          <Input placeholder="Instructor Name" icon  onChange={this.handleChange}>
            <input />
        ...
        <CourseDropDown course={this.props.course} increment={this.props.increment} setCourse={this.props.setCourse}/>
    </div>
    )
  }
}
